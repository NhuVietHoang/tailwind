...
<v-app id="inspire">
    ...
    <v-navigation-drawer absolute color="grey-lighten-3" rail>
    ...
    <v-app-bar class="px-3" color="grey-lighten-4" flat height="72">
        ...
        <v-responsive max-width="156">
            <v-text-field bg-color="grey-lighten-2" class="rounded-pill overflow-hidden" density="compact" hide-details variant="solo"></v-text-field>
        </v-responsive>
    </v-app-bar>
    ...
    <v-footer app height="72">
        <v-text-field bg-color="grey-lighten-1" class="rounded-pill overflow-hidden" density="compact" hide-details variant="solo"></v-text-field>
    </v-footer>
</v-app>
</template>
